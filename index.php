...
<div class="down_from_top" id="down_from_top" style='display:none;'>
  ...
  <div id="wrapper" >
    ...
    <div class="  bro" >
    <img src="images/rotana.png" id='seventyfive' width='50%' class='rotate-15  ' style='border-radius:40%;float:right;margin-right:10px;'alt="" class='col-md-5 col-xs-12'>
...
<span class='logo_text'>Rotan<br> Flour <br>Mills</span>
   ...
   <div class="dropdown" style='float:right;'>
    <div class="btn btn-default dropdown-toggle bro" type="button" id="menu1" data-toggle="dropdown">  الصادرات  
    <span class="caret"></span></div>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" style='text-align:right;'>
   ...
   <div class="dropdown" style='float:right;'>
    <div class="btn btn-default dropdown-toggle bro" type="button" id="menu1" data-toggle="dropdown">الفواتير
    <span class="caret"></span></div>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" style='text-align:right;'>
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">اضافة فاتورة</a></li>
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">عرض الفواتير</a></li>
     
    </ul>
  </div>   
  <div class="dropdown" style='float:right;'>
    <div class="btn btn-default dropdown-toggle bro" type="button" id="menu1" data-toggle="dropdown">الموظفين
    <span class="caret"></span></div>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" style='text-align:right;'>
  ...
  <div class="dropdown" style='float:right;'>
    <div class="btn btn-default dropdown-toggle bro" type="button" id="menu1" data-toggle="dropdown">المستخدمين
    <span class="caret"></span></div>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" style='text-align:right;'>
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">اضافة مستخدم</a></li>
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">عرض المستخدمين</a></li>
