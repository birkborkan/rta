...
--
-- Host: localhost
-- Generation Time: Nov 01, 2019 at 05:26 AM
...
(35, '   ww   ', '   ww   ', '   ww   ', 1500, '2019-10-25'),
(33, 'ttt', 'ttt', 'ttt', 1200, '2019-10-09');
...
(101, '50ك', 'مدعوم', 200, 800, 0, 0, '2019-10-31'),
(108, 'خميرة', 'تجاري', 12000, 1000, 0, 0, '2019-10-31');
...
(79, 101, 'اسعد', '6862 ج د', 'كمال عمر', '50ك', 1200, 'مدعوم', 650000, 45000, 23000, 3000, 721000, '2019-10-29', 1, ''),
(80, 101, 'مهدي', '12ج د', 'الهادي', '50ك', 1500, 'مدعوم', 60000, 39997, 0, 0, 99997, '2019-10-19', 1, ''),
(81, 101, 'حسن عبدالله', '123 ج ح', 'تامر', '50ك', 1000, 'مدعوم', 0, 0, 0, 0, 0, '2019-10-05', 1, ''),
(82, 101, 'ahmed', '122', 'omer', '50ك', 1200, 'مدعوم', 760000, 54000, 20000, 2500, 836500, '2019-10-01', 1, ''),
(83, 108, 'اسعد', '6862 ج د', 'كمال عمر', 'خميرة', 600, 'تجاري', 0, 0, 0, 0, 0, '2019-10-02', 1, ''),
(84, 101, 'birk', 'kk98', 'mnal', '50ك', 9000000, 'مدعوم', 101010, 5555, 990, 0, 107555, '2019-10-25', 1, ''),
(85, 108, 'محمد عبدالله', '121 ج ك', 'احمد عباس', 'خميرة', 3000, 'تجاري', 600000, 45000, 30000, 3000, 678000, '2019-10-25', 1, '');
...
INSERT INTO `store_imp` (`eid`, `sid`, `dname`, `cno`, `pname`, `ptype`, `pqty`, `psel`, `pcost`, `borsa`, `pbuy`, `ppro`, `plos`, `ldate1`, `ldate2`, `stor`) VALUES
(79, 101, 'كمال عمر', '6862 ج د', '50ك', 'مدعوم', 1200, 0, 0, 0, 0, 0, 0, '2019-10-29', '2019-10-30', '0'),
(80, 101, 'الهادي', '12ج د', '50ك', 'مدعوم', 1500, 0, 0, 0, 0, 0, 0, '2019-10-19', '2019-10-30', '1'),
(81, 101, 'تامر', '123 ج ح', '50ك', 'مدعوم', 1000, 0, 0, 0, 0, 0, 0, '2019-10-05', '2019-10-31', '1'),
(82, 101, 'omer', '122', '50ك', 'مدعوم', 1200, 0, 0, 0, 0, 0, 0, '2019-10-01', '2019-10-31', '1'),
(83, 108, 'كمال عمر', '6862 ج د', 'خميرة', 'تجاري', 600, 0, 0, 0, 0, 0, 0, '2019-10-02', '2019-10-31', '1'),
(84, 101, 'mnal', 'kk98', '50ك', 'مدعوم', 9000000, 0, 0, 0, 0, 0, 0, '2019-10-25', '2019-10-31', '1'),
(85, 108, 'احمد عباس', '121 ج ك', 'خميرة', 'تجاري', 3000, 0, 0, 0, 0, 0, 0, '2019-10-25', '2019-10-31', '1');
...
--
ALTER TABLE `emp`
  MODIFY `eid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
...
--
ALTER TABLE `salaries`
  MODIFY `sid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `store_exp`
  MODIFY `eid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
